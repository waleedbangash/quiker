...
class EProviderDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('document', function ($eProvider) {
                return "<a href='".$eProvider->document."'  class='badge bg-" . setting('theme_color') . " p-1 m-2'>View Document</a>";
            })
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                 'data' => 'document',
                'title' => trans('lang.e_provider_document'),
                'searchable' => false, 'orderable' => false, 'exportable' => false, 'printable' => false
            ],
            [
                'data' => 'name',
